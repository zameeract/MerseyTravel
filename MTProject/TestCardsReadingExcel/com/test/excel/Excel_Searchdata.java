    ...
    public class Excel_Searchdata
    {
        ...
        public static void read(final int RowNumber) throws Exception
        {
            ...
            for(int i=RowNumber; i<=RowNumber;  i++)
            {
                ...
                System.out.println("Row data " + Title  + Surname + Gender  + DateOfBirth + Issueauthority +Disability_status + Apprentice_card + Staff_number + Staff_job_title );
